...
try:
    fertilizer_model = joblib.load(os.path.join(BASE_PATH, 'models', 'fertilizer_app.pkl'))
...
crop_model = None
try:
    crop_model = joblib.load(os.path.join(BASE_PATH, 'models', 'crop_app.pkl'))
...
try:
    yield_model = pickle.load(open(os.path.join(BASE_PATH, 'models', 'dtr.pkl'), 'rb'))
    yield_preprocessor = pickle.load(open(os.path.join(BASE_PATH, 'models', 'preprocesser.pkl'), 'rb'))
